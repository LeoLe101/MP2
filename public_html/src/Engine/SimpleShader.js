...
function SimpleShader(vertexShaderPath, fragmentShaderPath) {
    ...
    // Step D: Gets a reference to the VertexPosition attribute within the shaders depending on what Vertex Shader:
    var vertexPosition = null;
    if (vertexShaderPath === "src/GLSLShaders/SimpleTriVS.glsl") {
        vertexPosition = "aTriangleVertexPosition";
    } else if (vertexShaderPath === "src/GLSLShaders/SimplePolVS.glsl") {
        vertexPosition = "aPolygonVertexPosition";
    } else if (vertexShaderPath === "src/GLSLShaders/SimpleStarVS.glsl") {
        vertexPosition = "aStarVertexPosition";
    } else {
        vertexPosition = "aSquareVertexPosition";
    }
    this.mShaderVertexPositionAttribute = gl.getAttribLocation(
        this.mCompiledShader, vertexPosition);
